...
export function Quiz() {
  ...
  const questions = useMemo(() => buildQuiz(medicines, 10), [medicines])
    ...
    return (
      <div className="mx-auto max-w-md space-y-4 text-center">
        ...
        <button
          ...
          className="rounded-full bg-gradient-to-r from-brand-400 to-brand-700 shadow-lg shadow-brand-300/30 px-5 py-2.5 font-semibold text-white hover:brightness-105 active:scale-95 transition-all"
        >
          Try again
        </button>
      </div>
  ...
  function choose(i: number) {
    ...
    recordAnswer(q.medicineId, correct)
  }
